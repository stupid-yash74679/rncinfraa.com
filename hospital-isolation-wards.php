    ...
    <div class="banner-inner">
        <div class="auto-container">
            <div class="inner-container clearfix">
                <h1>Hospital/Isolation wards</h1>
                <div class="page-nav">
                    <ul class="bread-crumb clearfix">
                        ...
                        <li class="active">Hospital/Isolation wards</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="content-side col-lg-12 col-md-12 col-sm-12">
                <div class="service-details">
                    ...
                    <div class="text-content">
                        <h3>Hospital/Isolation wards</h3>
                     ...
                     <div class="gallery-item col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="cap-box">
                           <div class="cap-inner">
                              ...
                              <div class="title">
                                 <h5><a href="javascript:;">Hospital/Isolation wards</a></h5>
                              </div>
                           </div>
                        </div>
                     </div>
